        ...
        isAuthenticated && (
            <>
                ...
                <div className="grid grid-cols-2 items-center justify-items-center bg-gray-50 p-10">
                    ...
                    className="col-start-2 text-2xl w-50 h-50 border-4 border-black rounded text-center bg-blue-900 hover:bg-blue-900 text-white
                            ...
                            {/*Service Icon*/}
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 24" strokeWidth={1.3} stroke="currentColor" className="size-20">
                    ...
                    <div className="grid grid-cols-2 gap-x-5 gap-y-4 items-start justify-items-start bg-gray-50 p-10">
                        <button onClick={() => redirectToMyRequest()}
                                className="text-2xl w-50 h-50 border-4 border-black rounded text-center bg-blue-900 hover:bg-blue-900 text-white
                                    animate-in fade-in zoom-in duration-500 p-4 font-nunito hover:scale-110 cursor-pointer flex flex-col items-center justify-center space-y-2">
                            {/*Calendar Icon*/}
