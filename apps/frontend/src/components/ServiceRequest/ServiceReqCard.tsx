        ...
        <Dialog>
            <div className=" relative w-[300px] h-[400px] rounded-lg shadow-md hover:shadow-lg cursor-pointer transition-shadow duration-300">
                ...
                <img
                    src={image}
                    alt={title}
                    className="border-4 border-blue-900 absolute inset-0 w-full h-[350px] rounded-md object-cover"
                />

                {/* Overlay Text Box */}
                    <DialogTrigger asChild>
                        <div className="border-4 border-amber-600 absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[250px] bg-white rounded-md bg-opacity-90 p-4 hover:bg-[#012D5A] hover:text-amber-600 transition-colors duration-200 active:scale-95">
