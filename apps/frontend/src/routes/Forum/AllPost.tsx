                ...
                <div className="flex flex-col md:flex-row md:items-center md:gap-4 mb-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                        <input
                            ...
                            className="border border-gray-300 rounded-xl px-4 py-2 flex-grow md:flex-none focus:outline-none focus:ring-2 focus:ring-blue-900 transition"
                            value={searchQuery}
                        ...
                        <ForumPostPopup
                            onUpdate={fetchData}
                            trigger={
                                <button className="bg-blue-900 text-white px-5 py-2 rounded-xl hover:bg-black transition">
                                    + Make a Post
                                </button>
                            }
                        />
